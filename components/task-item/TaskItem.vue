...
<template>
  ...
  >
    <div class="flex items-center gap-3">
      ...
      >
        <div v-if="isLoading"
             class="w-6 h-6 rounded-full border-2 border-t-transparent border-blue-500 animate-spin"></div>
        <div v-else-if="task.completed" class="w-6 h-6 rounded-full bg-green-700 flex items-center justify-center">
